...
class Nocs extends Dbo{
    ...
    public function getBackup(){
     ...
     public function insertIncidentesApi($id_host, $id_incidente,$descricao,$data_abertura){

       $status = "ABERTO";

       $query = "INSERT IGNORE INTO `incidentes` SET ID_HOST =:ID_HOST, ID_INCIDENTE =:ID_INCIDENTE, DESCRICAO =:DESCRICAO, DATA_ABERTURA =:DATA_ABERTURA, STATUS =:STATUS";
