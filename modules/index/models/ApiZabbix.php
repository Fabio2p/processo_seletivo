...
class ApiZabbix{
     ...
     * */
    public function responseApiZabbixCreateHost($urlApiZabbix, $authApiZabbix, $iUserZabix,$method, $host,$nomeVisivel,$groupid, $templateid, $descricao, $interfacesOpcionais = NUll){
     ...
     *Trata os dados api zabbix  para cadastro de hosts.
     * */
    public function responseApiZabbixUpdateHost($urlApiZabbix, $authApiZabbix, $iUserZabix,$method, $hostid, $host,$nomeVisivel, $descricao, $interfacesOpcionais = NUll, $groupid,$templateid){
     ...
     * */
    public function responseApiZabbixCreateItens($urlApiZabbix, $authApiZabbix, $iUserZabix,$method, $nome, $key_, $hosts, $applications, $delay){
    ...
    */
    public function buscaEventoAbertoApiZabbix($urlApiZabbix, $authApiZabbix, $iUserZabix, $method){
    ...
    *Filtra um determinado id de um determinado evento fechado
    */
    public function buscaEventoFechadoApiZabbix($urlApiZabbix, $authApiZabbix, $iUserZabix, $method, $r_eventid = NULL){
